...
// Dynamic booking URL helper — always generates today/tomorrow dates
function buildBookingUrl(extra = '') {
  const today = new Date();
  const tomorrow = new Date(today.getTime() + 86400000);
  const fmt = (d) => d.toISOString().split('T')[0];
  return `https://direct-book.com/properties/akageraparkinn?locale=en&items[0][adults]=2&items[0][children]=0&items[0][infants]=0&currency=USD&checkInDate=${fmt(today)}&checkOutDate=${fmt(tomorrow)}&trackPage=yes${extra}`;
}

const SLIDE_IMAGES = [
  { src: '/img/1.jpg', alt: 'Akagera Park Inn exterior' },
  { src: '/img/2.jpg', alt: 'Akagera Park Inn grounds' },
  { src: '/img/3.jpg', alt: 'Akagera Park Inn view' },
  { src: '/img/abt.jpg', alt: 'Akagera National Park landscape' },
];

const Home = () => {
  usePageInit();

  // --- Hero Slider (React state) ---
  const [currentSlide, setCurrentSlide] = useState(0);
  const sliderTimer = useRef(null);

  const goToSlide = useCallback((n) => {
    setCurrentSlide((n + SLIDE_IMAGES.length) % SLIDE_IMAGES.length);
  }, []);
  ...
  // Booking form state — initialized lazily to avoid useEffect set-state warning
  ...
  const handleBooking = () => {
    ...
    window.open(`https://direct-book.com/properties/akageraparkinn?${params.toString()}`, '_blank', 'noopener,noreferrer');
  };
  ...
  return (
    <div className="hly-page">
      ...
      <section className="hly-banner" id="hly-top">
        ...
        <div className="hly-slides" id="hlySlides">
          {SLIDE_IMAGES.map((slide, i) => (
            <div
              key={i}
              className={`hly-slide${i === currentSlide ? ' active' : ''}`}
        ...
        <div className="hly-banner-overlay" />
        ...
        <div className="hly-banner-content">
          ...
          <div className="hly-banner-actions">
            <a className="theme-btn" href={bookingUrl} target="_blank" rel="noopener noreferrer">
              Book Now
        ...
        <div className="hly-banner-dots" id="hlyDots">
          {SLIDE_IMAGES.map((_, i) => (
            <button
              key={i}
              className={`hly-dot${i === currentSlide ? ' active' : ''}`}
        ...
        <div className="hly-container">
          <div className="hly-section-header">
            ...
            <div className="hly-section-header-right">
              <a className="theme-border-btn" href={bookingUrl} target="_blank" rel="noopener noreferrer">
                All Rooms
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="hly-room-card">
              <div className="hly-room-img">
                <a href={bookingUrl} target="_blank" rel="noopener noreferrer">
                  <img src="https://api.akageraparkinn.com/storage/rooms/229c466c-9159-4a8f-b174-2a6515a4502b.jpeg" alt="Double Room with garden views" loading="lazy" />
                </a>
              </div>
              <div className="hly-room-body">
                <h4><a href={bookingUrl} target="_blank" rel="noopener noreferrer">Double Room</a></h4>
                ...
                <div className="hly-room-footer">
                  <a className="hly-read-more" href={bookingUrl} target="_blank" rel="noopener noreferrer">Book Now</a>
            ...
            <div className="hly-room-card">
              <div className="hly-room-img">
                <a href={bookingUrl} target="_blank" rel="noopener noreferrer">
                  <img src="https://api.akageraparkinn.com/storage/rooms/34223768-6ecf-4741-82e4-41f6301f6adc.jpeg" alt="Twin Room with two separate beds" loading="lazy" />
                </a>
              </div>
              <div className="hly-room-body">
                <h4><a href={bookingUrl} target="_blank" rel="noopener noreferrer">Twin Room</a></h4>
      ...
      {/* ── Restaurant Section ── */}
      <section className="hly-section hly-restaurant-home">
        <div className="hly-container">
          <div className="hly-about-grid">

            <div className="hly-about-content">
              <span className="subtitle__one">Dining &amp; Bar</span>
              <h2>The Akagera Table</h2>
              <p>Our restaurant celebrates the rich flavours of Rwanda — fresh lake fish, garden-grown vegetables, and traditional recipes reimagined for the modern traveller. Breakfast, lunch, dinner, and an all-day bar with stunning garden views.</p>
              <ul className="hly-place-list" style={{ marginTop: '1.2rem' }}>
                <li>
                ...
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#B89146"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                  Local Rwandan cuisine &amp; international dishes
                </li>
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#B89146"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                  Full bar open until 23:00
                </li>
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#B89146"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"/></svg>
                  Private dining &amp; events on request
                </li>
              </ul>
              <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginTop: '2rem' }}>
                <Link className="theme-btn" to="/restaurant" style={{ display: 'inline-flex' }}>
                  View Menu
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </Link>
                <Link className="theme-border-btn" to="/restaurant#rest-menu" style={{ display: 'inline-flex' }}>
                  Reserve a Table
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </Link>
              </div>
            ...
            <div className="hly-about-image-right" style={{ position: 'relative' }}>
              <img src="/img/p4.jpg" alt="The Akagera Table restaurant dining area" loading="lazy" />
              <div className="hly-about-badge">
                <span className="hly-badge-num">🍽</span>
                <span className="hly-badge-text">Open<br />Daily</span>
              </div>
            </div>
        ...
        <div className="hly-container">
          <div className="hly-about-grid">
            ...
            <div className="hly-about-image">
              <img src="/img/abt.jpg" alt="Akagera Park Inn entrance and gardens" loading="lazy" />
            </div>
            ...
            <div className="hly-about-image-right">
              <img src="/img/p1.jpg" alt="Akagera Park Inn swimming pool" loading="lazy" />
              <div className="hly-about-badge">
          ...
          <div className="hly-booking-form-wrap">
            ...
            <div className="hly-booking-form">
              <div className="hly-booking-field">
                <label htmlFor="hly-checkin">Check In</label>
                <input
                  type="date"
                  id="hly-checkin"
                  value={checkIn}
              ...
              <div className="hly-booking-field">
                <label htmlFor="hly-checkout">Check Out</label>
                <input
                  type="date"
                  id="hly-checkout"
                  value={checkOut}
              ...
              <div className="hly-booking-field">
                <label htmlFor="hly-roomtype">Room Type</label>
                <select id="hly-roomtype" value={roomType} onChange={(e) => setRoomType(e.target.value)}>
              ...
              <div className="hly-booking-submit">
                <button className="theme-btn" onClick={handleBooking} type="button">
                  Check Now
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </button>
              </div>
          ...
          <div className="hly-place-grid">
            <div className="hly-place-images">
              <div className="hly-place-img-top">
                <img src="/img/3.jpg" alt="Akagera National Park scenery" loading="lazy" />
              </div>
              <div className="hly-place-img-bottom">
                <img src="/img/p3.jpg" alt="Pool area at Akagera Park Inn" loading="lazy" />
              </div>
            </div>
            <div className="hly-place-content">
              ...
              <Link className="theme-btn" to="/gallery" style={{ display: 'inline-flex', marginTop: '2rem' }}>
                View Gallery
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
              </Link>
            </div>
